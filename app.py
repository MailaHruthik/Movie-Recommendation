...
data = pd.read_csv("C:\\Users\\HRUTHIK\\Downloads\\movies.csv")
...
select = st.selectbox("Select movie from dropdown", movies_list)
...
if st.button("Show Recommend"):
    movie_name, movie_poster = recommend(select)
